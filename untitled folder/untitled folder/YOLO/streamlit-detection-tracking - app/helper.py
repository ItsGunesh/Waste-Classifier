...
with open(r'/Users/admin/Desktop/ECOREWARDS/YOLO/streamlit-detection-tracking - app/weights/yolov8 (1).pkl', 'rb') as file:
...
def load_model(model_path):
    ...
    """
    model = YOLO(r'/Users/admin/Desktop/ECOREWARDS/YOLO/streamlit-detection-tracking - app/weights/yoloooo.pt')
    return model
